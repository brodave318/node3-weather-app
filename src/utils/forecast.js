...
const forecast = (lati, longi, callback) => {
  ...
  request({ url, json: true }, (error, { body }) => {
    if (error) {
      ...
      callback(undefined, `${body.daily.data[0].summary} It is currently ${body.currently.temperature} degrees out. This is a ${body.currently.precipProbability}% chance of rain.`);
    };
  });
};
